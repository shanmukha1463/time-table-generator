...
public class MyTableModel1 extends AbstractTableModel {
	...
	public MyTableModel1(String username){
		uname=username;
		conn=sqlconnection.dbconnector();
		try{
			String query="select * from timetable_course_school where cid in(select cid from courses where f_id=?) order by day,slot";
