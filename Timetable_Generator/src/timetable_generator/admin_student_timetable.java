...
public class admin_student_timetable extends JFrame {
	...
	public static admin_student_timetable frame = new admin_student_timetable();
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					admin_student_timetable frame = new admin_student_timetable();
	 ...
	 * Create the frame.
	 */
	public admin_student_timetable() {
	...
	public admin_student_timetable(String username,String username1) {
		uname=username;
		uname1=username1;
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1341, 602);
		...
		table = new JTable(new MyTableModel(uname1));
		scrollPane.setViewportView(table);
	}
}
